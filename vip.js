...
async function poptto() {
    if (process.argv.length !== 6) {
        console.log(colorize('Cách sử dụng: node vip.js url threads proxy/off/proxy.txt').bgRed);
        console.log(colorize('VD: node vip.js https://baostar.pro/ 3000 10 proxy').bgBlue);
        console.log(colorize('Make By Phan Anh Tuấn').bgCyan);
        process.exit(0);
    }else{
